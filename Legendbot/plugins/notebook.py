...
async def write_page(event):  # sourcery skip: low-code-quality
    ...
    if cmd == "write":
        ...
        if text == "-f":
            if not rtext.media:
                return await eod(event, "**ಠ∀ಠ Reply to any kinda Text file**")
    ...
    if not os.path.exists(temp_name):
        urllib.request.urlretrieve(
            f"https://github.com/LEGEND-AI/LEGENDUSERBOT-Resources/raw/master/Resources/Notebook/Images/{page}.jpg",
            temp_name,
        )
    if not os.path.exists(font_name):
        urllib.request.urlretrieve(
            f"https://github.com/LEGEND-AI/LEGENDUSERBOT-Resources/blob/master/Resources/Notebook/Fonts/{font}.ttf?raw=true",
            font_name,
        )
...
async def notebook_conf(event):  # sourcery skip: low-code-quality
    ...
    urllib.request.urlretrieve(
        f"https://github.com/LEGEND-AI/LEGENDUSERBOT-Resources/raw/master/Resources/Notebook/Images/{temp_page}.jpg",
        file,
    )
